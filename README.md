# Pz Joomla 3.8.1 payment gateway installation guide
...
3.) Goto Extensions=>plugins and search for "VM-Payment, PZ", place check on the VM-Payment, PZ and click on the "Enable" button.

4.) Goto VirtueMart=>Payment Methods

5.) Click on the "New" button to create Payment Method for "VM-Payment, PZ"
